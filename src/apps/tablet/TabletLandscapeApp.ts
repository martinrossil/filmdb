...
export default class TabletLandscapeApp extends Container {
    public constructor() {
        super();
    ...
    private get moviesList(): DataContainer<IMoviePreview> {
        if (!this._moviesList) {
            ...
            this._moviesList.style.paddingLeft = '96px';
            this._moviesList.style.paddingTop = '88px';
    ...
    private get navigation(): IContainer {
        if (!this._navigation) {
            ...
            this._navigation.width = 80;
            this._navigation.left = 0;
            this._navigation.bottom = 0;
            this._navigation.top = 72;
        }
...
customElements.define('tablet-landscape-app', TabletLandscapeApp);
